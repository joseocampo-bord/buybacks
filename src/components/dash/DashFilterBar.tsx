...
// Same pattern as Soga's FilterBar.tsx (filter-chip pill + "Ordenar"), just
// Dash's own filter set per the Figma reference (Fecha / País, not Soga's
// Empresa/País/Responsable/SLA-ETA/Marca/Tipo — the client doesn't filter by
// internal fields like "Responsable").
const FILTERS = ['Fecha', 'País']
